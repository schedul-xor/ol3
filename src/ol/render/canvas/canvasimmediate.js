...
/**
 * Render a Cubic bezier geometry into the canvas.  Rendering is immediate
 * and uses the current style.
 * @param {ol.geom.CubicBezier} cubicBezierGeometry
...
ol.render.canvas.Immediate.prototype.drawCubicBezierGeometry =
  ...
  var geometryExtent = cubicBezierGeometry.getExtent();
